...
const getData = () => {
    fetch(API_ENDPOINT + '/sumberdayageologis')
...
const getDataById = (id) => {
    fetch(API_ENDPOINT + '/sumberdayageologi/' + id)
        .then(response => response.json())
        .then(data => {
...
const displayData = (dataArray) => {
    ...
    updateButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            ...
            getDataById(id);
            window.location.href = '/update/updatesumberdayageologi.html?id=' + id;
    ...
    const postData = (data) => {
        fetch(API_ENDPOINT + '/sumberdayageologi', {
            method: 'POST',
            headers: {
